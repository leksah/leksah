...
Version:        1.1.2
Release:        1%{?dist}
Summary:        Haskell regex-tdfa implementation
...
BuildRequires:  ghc, ghc-rpm-macros, ghc-regex-base-devel, ghc-regex-base-prof
%if %{with doc}
...
%package devel
Summary:        Haskell regext-tdfa implementation
