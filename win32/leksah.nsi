...
Section "Leksah"
  ...
  File "$%LEKSAH_PREFIX%\bin\vcswrapper.exe"
  File "$%LEKSAH_PREFIX%\bin\vcsgui.exe"
  File "$%LEKSAH_PREFIX%\bin\vcsgui-askpass.exe"
  File "$%LEKSAH_SERVER_PREFIX%\bin\leksah-server.exe"
  File "$%LEKSAH_SERVER_PREFIX%\bin\leksahecho.exe"
  File "$%GTK_PREFIX%\bin\iconv.dll"
  File "$%GTK_PREFIX%\bin\icudata48.dll"
  File "$%GTK_PREFIX%\bin\icui18n48.dll"
  File "$%GTK_PREFIX%\bin\icule48.dll"
  File "$%GTK_PREFIX%\bin\icuuc48.dll"
  ...
  File "$%GTK_PREFIX%\bin\libgst*-0.10-0.dll"
