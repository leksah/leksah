...
let
  cleanSrc =
    pkgs.lib.cleanSourceWith {
      ...
      filter = path: type: # FIXME: How to re-use .gitignore? https://git.io/vSo80
        pkgs.lib.all (i: toString i != path) [ ../.DS_Store ../osx/Leksah ../osx/keymap.lkshk ../osx/prefs.lkshp ../win32/SourceDir ../default.nix ../result ]
  ...
  # our packages
  plan-nix = haskell.cabalProjectToNix { src = cleanSrc; };
